...
os.makedirs("class_conditional_dcwgan_gp_images", exist_ok=True)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            *discriminator_block(opt.channels+1, 16),
...
def sample_image(n_row, batches_done):
    ...
    save_image(gen_imgs.data, "class_conditional_dcwgan_gp_images/%d.png" % batches_done, nrow=n_row, normalize=True)
