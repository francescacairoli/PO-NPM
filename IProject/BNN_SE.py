...
class BNN_SE():
	...
	def load_train_data(self):
		...
		self.traj_len = X.shape[2]
		
		self.Y_train = np.reshape(Y,(self.n_training_points, self.y_dim*self.traj_len))
		self.X_train = np.reshape(X,(self.n_training_points, self.x_dim*self.traj_len))
	...
	def load_test_data(self):
		...
		self.X_test = np.reshape(X,(self.n_test_points, self.x_dim*self.traj_len)) # flatten
		self.Y_test = np.reshape(Y,(self.n_test_points, self.y_dim*self.traj_len)) # flatten
